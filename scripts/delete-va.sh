...
# ==========================================================
# Script Simulasi Delete Virtual Account (SNAP API Winpay)
# ==========================================================
# Format:
#   delete-va.sh [ENVIRONMENT]
#
# Environment:
...
echo "🚀 Menjalankan Simulasi Delete VA (SNAP)"
echo "----------------------------------------"
echo "📌 Environment  : $ENV"
echo "📌 Project Dir  : $SCRIPT_DIR"
echo "----------------------------------------"

NODE_ENV="$ENV" node simulator.js snap deleteva
